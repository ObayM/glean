...
export async function ankiConnectRequest(action, params = {}) {
...
export async function testConnection() {
  return ankiConnectRequest('version');
}

export async function getDeckNames() {
  return ankiConnectRequest('deckNames');
}

export async function createDeck(name) {
  return ankiConnectRequest('createDeck', { deck: name });
}

export async function getModelNames() {
  return ankiConnectRequest('modelNames');
}

export async function createModel(name, fields, cardTemplates) {
  return ankiConnectRequest('createModel', {
    modelName: name,
...
export async function addNote(deckName, modelName, fields, tags = [], audio = []) {
  const note = {
    deckName,
    modelName,
    fields,
...
export async function findNotes(query) {
  return ankiConnectRequest('findNotes', { query });
}
...
export async function ensureNoteType() {
  ...
  await createModel(MODEL_NAME, MODEL_FIELDS, cardTemplates);
}
