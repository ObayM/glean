function initLiquidGlass(root = document) {
  const displacementMap = root.querySelector('#liquid-refraction feDisplacementMap');
  const specularLighting = root.querySelector('#liquid-refraction feSpecularLighting');
